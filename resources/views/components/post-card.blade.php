    ...
    <div class="py-5 px-4">
        ...
        <div class="mt-5 flex flex-col justify-between">
            ...
            <div class="text-sm mt-2">
                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ad fugit quaerat aliquam, molestias assumenda hic sint cum culpa a atque nam quod quis delectus labore dicta reiciendis. Corporis, inventore sunt.</p>
                
                <p class="mt-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vero, officiis?</p>
            </div>
            ...
            <footer class="flex justify-between items-center mt-8">
                ...
                <div>
                    <a href="#" class="hidden lg:block text-xs font-semibold bg-gray-300 rounded-full  py-2 px-8">Read More</a>
                </div>
            </footer>
