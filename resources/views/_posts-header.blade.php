<header class="max-w-xl mx-auto mt-20 text-center">
    ...
    <h2 class="inline-flex text-xl">By Lary Laracore <img src="/images/lary-head.svg" alt="Head of larry mascot"></h2>
    ...
    <div class="mt-8 space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
        <!-- Category -->
        <div class="relative lg:inline-flex bg-gray-200 rounded-xl">
            ...
            <div x-data="{ show: false }" @click.away="show = false">
                ...
                <svg class="transform -rotate-90 absolute pointer-events-none"
                     style="right: 12px;" width="22" height="22" viewBox="0.83 1 20.15 20.15">
        ...
        <!-- Other Filters -->
        <span class="relative flex lg:inline-flex items-center bg-gray-200 rounded-xl">
        ...
        <!-- Search -->
        <span class="relative flex lg:inline-flex items-center bg-gray-200 rounded-xl px-3 py-2">
